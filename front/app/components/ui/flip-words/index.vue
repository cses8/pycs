        ...
        >
          <span
            ...
            :style="{
              ...
              animationDelay: getWordDelay(wordIndex),
            }"
          >
            <span
              ...
              :style="{
                ...
                animationDelay: getLetterDelay(wordIndex, letterIndex),
              }"
            >
              {{ letter }}
            </span>
...
const currentWord: Ref = ref(props.words[0])
const isVisible: Ref = ref(true)
const timeoutId: Ref = ref<number | null>(null)

function getWordDelay(wordIndex: string | number) {
  return `${Number(wordIndex) * 0.3}s`
}

function getLetterDelay(wordIndex: string | number, letterIndex: string | number) {
  return `${Number(wordIndex) * 0.3 + Number(letterIndex) * 0.05}s`
}
