<template>
  ...
  >
    <div
      ...
      class="fixed inset-0 z-[100] flex size-full items-center justify-center backdrop-blur-2xl bg-black/50"
    >
      <!-- Closing Button -->
      <button
        v-show="!preventClose"
      ...
      <div class="relative h-96">
        <div
          class="relative mx-auto mt-40 flex max-w-xl flex-col justify-start"
        >
          <div v-for="(step, index) in steps" :key="index">
            ...
            >
              ...
              <svg
                ...
                viewBox="0 0 24 24"
                fill="currentColor"
                class="size-6 animate-spin text-white/70"
              >
                <path
                  fill-rule="evenodd"
              ...
              <svg
                ...
                stroke-width="1.5"
                stroke="currentColor"
                class="size-6 text-white/70 opacity-50"
              >
                <path
                  stroke-linecap="round"
                  stroke-linejoin="round"
      ...
      <div
        class="absolute inset-x-0 bottom-0 z-20 h-full bg-white bg-gradient-to-t [mask-image:radial-gradient(900px_at_center,transparent_30%,white)]"
      ></div>
    </div>
  </Transition>
</template>
